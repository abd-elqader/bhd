            ...
            <div class="d-flex justify-content-center align-items-center w-100 h-100">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item h2 active" aria-current="page">{{ trans('messages.About Us') }}</li>
                  </ol>
                </nav>
            </div>
        </div>
...
<div class="container">
    <div class="row py-5 text-center">
        <div class="col-md-6">
            <img src="{{ public_asset(setting('about_image') ?? setting('logo')) }}" class="img-fluid" alt="image">
        </div>
        <div class="col-md-6">
