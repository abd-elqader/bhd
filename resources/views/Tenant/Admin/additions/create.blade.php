...
@section('content')
<form method="POST" action="{{ route('admin.additions.store') }}" data-parsley-validate novalidate>
    @csrf
    <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
            ...
            <input id="price" type="number" min="0" step="any" name="price" required placeholder="@lang('dashboard.price')" class="form-control">
        </div>
        <div class="col-md-6">
