...
@section('content')
<form method="POST" action="{{ route('admin.branches.store') }}" enctype="multipart/form-data" data-parsley-validate novalidate>
    @csrf
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="text" name="working_time_ar" id="working_time_ar" class="form-control" required >
        </div>
        <div class="form-group col-md-6">
            <label for="working_time_en">@lang('dashboard.working_time_en')</label>
            <input type="text" name="working_time_en" id="working_time_en" class="form-control" required >
        </div>
        <div class="form-group col-md-6">
