                ...
                <div class="my-4">
                    ...
                    <div class="container">
                       <ul class="row p-0 nav nav-tabs">
                          <li class="col-6 tabs__label py-3 border-0 text-center point active"  href="#1" data-toggle="tab">
                             <div>@lang('messages.Login')</div>
                          </li>
                          <li class="col-6 tabs__label py-3 border-0 text-center point" href="#2" data-toggle="tab">
