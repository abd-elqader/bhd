...
<form method="POST" action="{{ route('admin.packages.store') }}" enctype="multipart/form-data">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <input type="number" min="0" step="1" name="days" id="days" class="form-control" required>
        </div>

        <div class="form-group col-md-6">
            <label for="price">@lang('dashboard.price')</label>
            <input type="number" min="0" value="1" step="0.01" name="price" id="price" class="form-control" required>
        </div>

        <div class="form-group col-md-6">
            <label for="discount">@lang('dashboard.discount')</label>
            <input type="number" min="0" value="1" step="0.01" name="discount" id="discount" class="form-control" required>
        </div>
        <div class="form-group col-md-6">
        ...
        <div class="PackageDesc text-center col-12 mx-auto">
            <div class="row item">
                <div class="form-group  col-md-5 col-sm-12">
                    <label>@lang('dashboard.title_ar')</label>
                    <input type="text" placeholder="@lang('dashboard.title_ar')" id="desc_title_ar" class="form-control text-center">
                </div>
                <div class="form-group  col-md-5 col-sm-12">
                    <label>@lang('dashboard.title_en')</label>
                    <input type="text" placeholder="@lang('dashboard.title_en')" id="desc_title_en" class="form-control text-center">
                </div>
                        ...
                        <div class="row item my-1">
                            ...
                            <div class="form-group  col-md-6 col-sm-12 m-auto text-center">
                                @if ( $item->type == 'text' ||  $item->type == 'icon')
                                    <input placeholder="@lang('dashboard.title_ar')"   {{ $item->type == 'text' ? ''  : 'hidden'}}  name="feature_title_ar[]" type="text" {{ 'disabled' }} class="form-control text-center m-3">
                                    <input placeholder="@lang('dashboard.title_en')"   {{ $item->type == 'text' ? ''  : 'hidden'}}  name="feature_title_en[]" type="text" {{ 'disabled' }} class="form-control text-center m-3">
                                    @if ( $item->type == 'icon')
